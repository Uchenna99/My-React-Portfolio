...
const Hero2 = () => {
  ...
  return (
    <>
    <div className="w-full md:h-[800px] flex justify-center px-4 md:px-10 "
      style={{background: 'linear-gradient(to top, #1d293d 0%, #0f172b 60%, #0f172b 100%)'}}>

      <motion.div className="relative h-full w-[1200px] max-w-full bg-blend-darken flex flex-col-reverse items-center md:items-end 
      -between py-20 gap-5 overflow-hidden " ref={heroRef}
        ...
        <motion.div className="flex flex-col gap-6 z-20" ref={ref}
          initial={{opacity:0, y:80}} animate={{opacity:1, y:0}} transition={{duration:1, delay:0.3, ease:'easeOut'}} >

          <p className="text-slate-200 text-4xl md:text-5xl font-semibold ">Uchenna Agbu</p>
        ...
        <div className="w-[500px] h-[650px] rounded-full border-2 border-white bg-cover bg-center bg-no-repeat"
