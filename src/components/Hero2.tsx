  ...
  return (
    <>
      <div className="relative h-[800px] w-full bg-slate-800 bg-[0px_-370px] bg-cover bg bg-no-repeat bg-blend-darken
        flex flex-col items-center justify-center px-10 overflow-hidden " ref={heroRef}
        style={{background: 'linear-gradient(to top, #1d293d 0%, #0f172b 35%, #0f172b 100%)'}}>

        <div className="w-full lg:w-[1200px] flex flex-col gap-6 z-20 items-center md:items-start " ref={ref}>

          <p className="text-slate-200 text-5xl text-center font-semibold ">I'm Uchenna Agbu</p>

          <p className="text-slate-200 text-xl text-center font-semibold">Full Stack Web Developer</p>
        ...
        <img src={imageUrl} alt="My Photo" className="absolute right-[-240px] md:right-0 top-0 w-[900px] min-w-[900px] "/>
